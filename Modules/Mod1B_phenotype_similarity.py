...
class PhenotypeSimilarity(GenericSimilarity):
    ...
    def similarity_search(self):
        ...
        """
        self.ssr = {gene: self.ssw.get_phenotypically_similar_genes(input_gene=gene, phenotypes=phenotypes, taxon=self.taxon) for gene, phenotypes in self.gene2phenotype_associations.items()}
